...
```{r}
load("simulation_results/ci_results_simple.R")
```
...
```{r}
load("simulation_results/ci_results_2d.R")
```
...
```{r}
load("simulation_results/ci_results_large.R")
```
...
ggsave(
  "simple_ci_coverage_large_trunc.png",
  path = "images",
  scale = 2,
  width = 1200,
  height = 600,
